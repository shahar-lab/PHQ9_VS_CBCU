...
code_dir      <- file.path(project_root, "simulation", "bradley_terry_beta_tau_rho_recovery", "code")
artifacts_dir <- file.path(project_root, "simulation", "bradley_terry_beta_tau_rho_recovery", "artifacts")
output_dir    <- file.path(project_root, "simulation", "bradley_terry_beta_tau_rho_recovery", "output")
